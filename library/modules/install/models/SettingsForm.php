...
class SettingsForm extends UiFormModel
{
    ...
    public function rules()
    {
        return [
                  [['siteName', 'siteDescription', 'superUsername', 'superEmail', 'superPassword', 'dbHost', 'dbPort', 'dbName', 
                    'dbUsername', 'dbPassword', 'environment', 'frontTheme', 'timezone'], 'required'],
                  [['siteName', 'siteDescription', 'superUsername', 'superEmail', 'superPassword', 'dbHost', 'dbName', 'dbUsername', 
                    'dbPassword', 'dbAdminUsername', 'dbAdminPassword', 'environment', 'frontTheme', 'logo'], 'string'],
    ...
    public function scenarios()
    {
        ...
        $scenario['create']  = ['siteName', 'siteDescription', 'superUsername', 'superEmail', 'superPassword', 'dbHost', 'dbPort', 'dbName', 
                                'dbUsername', 'dbPassword', 'environment', 'dbAdminUsername', 'dbAdminPassword', 'frontTheme', 'timezone', 'logo', 
                                'demoData'];
        return $scenario;
    }
    /**
