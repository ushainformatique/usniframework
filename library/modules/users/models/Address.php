 ...
 */
class Address extends UiBaseActiveRecord
{
    ...
    public function rules()
    {
        ...
        else
        {
            return [
                        //Address rules
                        [['address1', 'city', 'country', 'postal_code'],    'required'],
	...
	/**
     * Get country name from its country code.
     * @return string country name
     */
    public function getCountryName()
    {
        return CountryUtil::getCountryName($this->country);
    }
